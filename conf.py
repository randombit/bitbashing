...
BLOG_AUTHOR = "Jack Lloyd"  # (translatable)
BLOG_TITLE = "Bitbashing"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://randombit.net/bitbashing/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://randombit.net/bitbashing/"
BLOG_EMAIL = "jack@randombit.net"
BLOG_DESCRIPTION = "Blathering"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete output/ jack@saria.randombit.net:/srv/http/randombit/bitbashing",
    ]
}
